...
const NAV_LINKS = [
  ...
  { label: "MEDIA", href: "https://www.youtube.com/channel/UCVuLOUNXvTP22EQqfgA7UkQ", target: "_blank" },
  { label: "CONTACT", href: "mailto:kiefer.likens@me.com" },
];

const SOCIALS = [
  {
    label: "X", href: "https://x.com/kieferlikens",
  ...
  {
    label: "Facebook", href: "https://www.facebook.com/kiefer.likens",
  ...
  {
    label: "Instagram", href: "https://www.instagram.com/kieferlikens/",
  ...
  {
    label: "YouTube", href: "https://www.youtube.com/@thecoolguyclub",
    icon: <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.5 12 3.5 12 3.5s-7.505 0-9.377.55a3.016 3.016 0 0 0-2.122 2.136C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.55 9.376.55 9.376.55s7.505 0 9.377-.55a3.016 3.016 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>,
  },
  {
    label: "LinkedIn", href: "https://www.linkedin.com/in/kieferlikens/",
    icon: <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>,
  },
];
